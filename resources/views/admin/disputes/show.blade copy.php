                                    ...
                                    @if($userEvidenceRequest)
                                        <div class="alert alert-{{ $userEvidenceRequest->status === 'submitted' ? 'success' : 'warning' }}">
                                            ...
                                            @if($userEvidenceRequest->status === 'pending')
                                                ...
                                                <p class="mb-2"><strong>Days Left:</strong> {{ $userEvidenceRequest->getDeadlineDaysLeft() }}</p>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-0">
                                        <span class="text-{{ $userEvidenceRequest->getDeadlineDaysLeft() <= 3 ? 'warning' : 'success' }}">
                                            {{ $userEvidenceRequest->getDeadlineDaysLeft() }} days remaining
                                        </span>
                                    </p>
                                </div>
                            </div>
