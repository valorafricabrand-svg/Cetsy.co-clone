...
<head>
    ...
    <style>
        ...
        .price { font-size: 24px; font-weight: bold; color: #dc3545; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We wanted to let you know that the seller has declined your offer for the following product:</p>
            ...
            <div class="product-card">
                ...
                <p><strong>Date Declined:</strong> {{ now()->format('d M Y, H:i') }}</p>
            </div>
            
            @if($offer->seller_notes)
                <div class="reason-box">
                    <h4>Seller's Response:</h4>
                    <p><em>"{{ $offer->seller_notes }}"</em></p>
                </div>
            @endif
            ...
            <ul>
                <li>Make a new offer with a different price</li>
                <li>Browse other similar products</li>
                <li>Contact the seller directly to discuss</li>
                <li>Check out other sellers' offers</li>
            </ul>
            ...
            <p>We encourage you to keep exploring our platform for great deals and opportunities!</p>
