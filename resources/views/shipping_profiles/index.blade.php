...
<div class="content">
    <div class="mb-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a href="{{ route('seller.shipping_profiles.create') }}" class="inline-flex w-full items-center justify-center rounded-xl px-4 py-2 text-sm font-semibold transition bg-emerald-600 text-white hover:bg-emerald-500 sm:w-auto">Add Shipping Profile</a>
    </div>
    ...
    @else
        <div class="rounded-xl border border-slate-200 bg-white px-4 py-5 text-sm text-slate-600">
            No shipping profiles found.
            <a href="{{ route('seller.shipping_profiles.create') }}" class="font-semibold text-emerald-700 hover:text-emerald-600">Create one now.</a>
        </div>
    @endif
</div>
@endsection
