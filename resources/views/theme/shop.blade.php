...
<section class="py-5 bg-light border-bottom">
  <div class="container d-flex flex-column flex-lg-row align-items-center justify-content-between gap-4">
    ...
    @if(Auth::id() === $shop->user_id)
      <a href="{{ route('shops.edit', $shop) }}" class="btn btn-outline-primary">
...
<section class="py-5">
  <div class="container">
    ...
    <div class="row g-4">
      ...
      <div class="col-lg-6">
        <div class="card shadow-sm h-100">
          <div class="card-header bg-white fw-semibold">Shop Preferences</div>
      ...
      <div class="col-12">
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            <p class="mb-1">{{ $shop->address ?? 'N/A' }}</p>
            <p class="mb-0">{{ $shop->city ?? '' }} {{ $shop->postal ? ', '.$shop->postal : '' }}</p>
          </div>
        </div>
      </div>
    </div>
...
<section class="py-5 bg-light">
  <div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h2 class="h5 fw-bold mb-0">Products from {{ $shop->name }}</h2>
