      ...
      loadMoreBtn.addEventListener('click', () => {
        ...
        fetch(nextUrl)
          ...
          .then(html => {
            ...
            doc.querySelectorAll('#gridView .product-item').forEach(el => gridView.appendChild(el));
            doc.querySelectorAll('#listView .product-item').forEach(el => listView.appendChild(el));
