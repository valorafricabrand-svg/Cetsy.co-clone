        ...
        <div class="grid gap-2 md:grid-cols-12 md:items-center">
          <div class="md:col-span-4">
            <div class="flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-2">
              ...
              <input type="search" name="q" value="{{ $q }}" placeholder="Search in {{ $catName }}..." class="min-w-0 w-full border-0 bg-transparent text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none" enterkeyhint="search">
              <button type="submit" class="shrink-0 rounded-full bg-emerald-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-emerald-500" aria-label="Search in {{ $catName }}">
                Search
              </button>
            </div>
          </div>
