...
<section class="py-6 bg-white position-relative overflow-hidden">
  <style>
    ...
    .eyebrow {
      ...
      background: rgba(25,135,84,.06); color:#198754;
      border:1px solid rgba(25,135,84,.25); font-weight:600; font-size:.85rem;
    }
    .feature-chip {
      display:flex; align-items:center; gap:.65rem;
      padding:.75rem 1rem; border-radius:.85rem; background:#fff;
    ...
    .stat-chip {
      ...
      background:#fff; border:1px solid rgba(0,0,0,.06); color:#198754;
    }
    ...
    .img-card:hover { transform: translateY(-4px); box-shadow: 0 16px 36px rgba(16,24,40,.16); }

    .badge-float {
      position:absolute; left:1rem; bottom:1rem;
      background: rgba(255,255,255,.9); backdrop-filter: blur(6px);
      border:1px solid rgba(0,0,0,.06); border-radius:.75rem;
      padding:.5rem .75rem; font-weight:700; color:#198754;
    ...
    .callout {
      ...
      border:1px solid rgba(25,135,84,.15); border-radius:1rem;
    }
    .list-icon li { padding-left:1.75rem; position:relative; margin-bottom:.5rem; }
    .list-icon li i {
      position:absolute; left:0; top:.2rem; color:#198754;
    }

    /* Buttons */
    .btn-pill { border-radius:999px; }
    .btn-soft-success {
      background: rgba(25,135,84,.08); color:#198754; border:1px solid rgba(25,135,84,.25);
    }
    .btn-soft-success:hover { background: rgba(25,135,84,.12); color:#157347; border-color: rgba(25,135,84,.35); }
  </style>
  ...
  <div class="container">
    <div class="row gx-5 align-items-center">
      ...
      <div class="col-12 col-lg-6 reveal">
        ...
        <p class="mb-3">If you can legally sell an item or service in your country, you can list it on Cetsy.</p>
        ...
        <ul class="list-unstyled list-icon mb-4">
          ...
          <li><i class="fas fa-check-circle"></i> Reach support anytime via email or 24/7 Live Chat.</li>
        </ul>
