    ...
    <div class="row g-lg-5">
      ...
      <div class="col-lg-5" data-aos="fade-left">
        <div class="position-lg-sticky top-lg-6">
         ...
         {{-- Purchase / Booking block --}}
@if($product->type !== 'service')
  {{-- ============== Physical / Shippable Product ============== --}}
    ...
    <div class="card-body d-flex align-items-center gap-3 flex-wrap">
      ...
      <div class="flex-grow-1">
        ...
        <p class="mb-0 small text-muted">
          This is a <strong>digital product</strong>. You’ll receive the file(s) immediately
          after completing checkout. No shipping required.
        </p>
      </div>
    </div>
  </div>

  {{-- purchase box (no shipping, qty fixed to 1) --}}
  <div class="border rounded-4 p-4 bg-light-subtle">
    <div class="mb-3">
      <span class="fw-semibold">Qty</span>
      <input type="text" class="form-control text-center d-inline-block ms-2" style="width:70px"
             value="1" readonly>
    </div>
...
<div class="card border-info border-start-4 shadow-sm mb-4">
  <div class="card-body d-flex flex-wrap align-items-center gap-3">
    ...
    <div class="flex-grow-1">
      ...
      <p class="mb-0 small text-muted">
        This item is a <strong>service</strong>. To schedule or request a custom quote, please contact the seller
        below.
      </p>
    </div>

    {{-- CTA Buttons (reuse existing modals) --}}
  ...
  <div class="modal-dialog">
    <form class="modal-content" method="POST" action="{{ route('messages.store') }}">
      ...
      <div class="modal-body">
        ...
        <textarea id="messageBody" name="message" rows="4" class="form-control"
                  placeholder="Hi, I’d like to ask about…" required></textarea>
      </div>
  ...
  <div class="modal-dialog">
    <form class="modal-content" method="POST" action="{{ route('offers.store') }}">
      ...
      <div class="modal-body">
        ...
        <input type="number" name="offer_price" id="offerPrice" min="1" step="1"
...
@push('styles')
<link rel="stylesheet"
      href="https://cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.css" integrity="sha384-PU0QFv1kXlz9BM/UX5EwyV/ivxVMolZTUsjoeetfYxNdUswzqnMHipjInu6bcVCc" crossorigin="anonymous">
<style>
  .thumb.active,
...
@push('scripts')
<script src="https://cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.js" integrity="sha384-xKDJcyOgCjL2mK9ZcYnmQgSJvMREh4baN4GckSbnREV7mY4T0kT2LSpJxErL8xP8" crossorigin="anonymous"></script>
<script>
  const toast = (msg,type='success')=>{
    ...
    document.body.appendChild(el);new bootstrap.Toast(el,{delay:3000}).show()
  }
