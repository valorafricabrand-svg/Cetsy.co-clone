    ...
    <div class="row gy-4" data-aos="fade-up">
      ...
      <div class="col-md-6 col-lg-4">
        <div class="h-100 p-4 border rounded-4 shadow-sm">
          ...
          <p class="mb-0">
            A secure online mall linking Kenyan buyers with verified sellers. Pay via M-Pesa, card or wallet in
            just a few taps. <a href="/about" class="fw-semibold text-warning">Read More</a>
          </p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="h-100 p-4 border rounded-4 shadow-sm">
          ...
          <p class="mb-3">
            Open your Jaat shop in minutes. Review the Seller Guidelines, list your products or services, and reach
            customers across Kenya. Need help? Chat live or email us—we’re here 24/7.
          </p>
          <a href="/register" class="btn btn-success btn-sm rounded-pill">
            Join Free
          </a>
        </div>
      </div>
...
@push('styles')
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.css" integrity="sha512-Ho+jjFzJFDN5XvPy6PAW9hqDfeaoCcZWagV2metM3y8FPCPlffpcajvQ1QHBYsBo81uDUfMcqbsVbWMH5b9YxA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
<style>
...
@push('scripts')
<script src="https://cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.js" integrity="sha512-QwrpYofeCvTR6rIhiuQr8y43X5YLkO3Ocdm+pNsoKmIV7xdZtc7N69n5xrF/PGG3v8tSWlKnOpE+UsWgkh7mXA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script>
