                        ...
                        <div class="header-stats">
                            ...
                            @if($notifications->where('is_read', false)->count() > 0)
                                <div class="stat-item">
                                    ...
                                    <span>{{ $notifications->where('is_read', false)->count() }} Unread</span>
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        @foreach($notifications as $notification)
                            <div class="notification-item {{ !$notification->is_read ? 'unread' : '' }}" 
                                ...
                                <div class="notification-content">
                                    <div class="notification-icon {{ !$notification->is_read ? 'unread' : '' }}">
                                        <i class="fas fa-bell"></i>
                                    </div>
        ...
        <div class="modal-content">
            <form id="markReadForm" method="POST">
                ...
                <div class="modal-body">
                    <p class="mb-2">Are you sure you want to mark this notification as read?</p>
                    <div class="alert alert-info mb-0">
                        <strong><i class="fas fa-info-circle me-2"></i>Notification:</strong>
