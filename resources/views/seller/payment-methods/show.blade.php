                ...
                <div class="rounded-2xl border border-slate-200 bg-white shadow-sm border-0">
                    ...
                    <div class="p-4">
                        <dl class="grid grid-cols-1 gap-4 md:grid-cols-12 mb-0">
                            <dt class="-span-3">ID</dt>
                            <dd class="-span-9">{{ $paymentMethod->id }}</dd>

                            <dt class="-span-3">Payment Type</dt>
                            <dd class="-span-9">
                            ...
                            <dt class="-span-3">Account Name</dt>
                            <dd class="-span-9">
                                <strong>{{ $paymentMethod->account_name }}</strong>
                            </dd>

                            <dt class="-span-3">Account Number</dt>
                            <dd class="-span-9">
                            ...
                            @if($paymentMethod->bank_name || $paymentMethod->bank_country || $paymentMethod->bank_currency || $paymentMethod->bank_routing_number || $paymentMethod->swift_bic || $paymentMethod->iban || $paymentMethod->bank_address)
                                <dt class="-span-3">Bank Details</dt>
                                <dd class="-span-9">
                            ...
                            @if($paymentMethod->wise_email || $paymentMethod->wise_recipient_id || $paymentMethod->wise_profile_id)
                                <dt class="-span-3">Wise Details</dt>
                                <dd class="-span-9">
                                    <div class="text-xs text-slate-500">
                            ...
                            <dt class="-span-3">Created</dt>
                            <dd class="-span-9">{{ $paymentMethod->created_at->format('d M Y, h:i A') }}</dd>

                            <dt class="-span-3">Last Updated</dt>
                            <dd class="-span-9">{{ $paymentMethod->updated_at->format('d M Y, h:i A') }}</dd>
                        </dl>
                    </div>
                </div>
