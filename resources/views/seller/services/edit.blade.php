        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Service name" value="{{ old('name', $service->name) }}">
                </div>
                <div class="mb-3">
                    <label for="phone" class="form-label">Phone Number <span class="text-danger">Required</span></label>
                    <input type="text" class="form-control" id="phone" name="phone" placeholder="+254 xxx xxx xxx" value="{{ old('phone', $service->phone) }}">
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">Service Provider Email Address <span class="text-danger">Required</span></label>
                    <input type="email" class="form-control" id="email" name="email" placeholder="Service Provider Email Address" value="{{ old('email', $service->email) }}">
                </div>
                <div class="mb-3">
                    <label for="location" class="form-label">Service Provider Geographical Location <span class="text-danger">Required</span></label>
                    <input type="text" class="form-control" id="location" name="location" placeholder="Service Provider Geographical Location" value="{{ old('location', $service->location) }}">
                </div>
                <div class="mb-3">
                    <label for="price" class="form-label">Price <span class="text-danger">Required</span></label>
                    <input type="number" class="form-control" id="price" name="price" min="0" step="0.01" value="{{ old('price', $service->price) }}">
                </div>
                <div class="mb-3">
                    <label for="origin_id" class="form-label">Country of Origin <span class="text-danger">Required</span></label>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="tags" name="tags" placeholder="e.g. Cleaning, Medical, Dog-Walking" value="{{ old('tags', $service->tags) }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label class="form-label">Renewal Options <span class="text-danger">Required</span></label>
                ...
                <div class="mb-3">
                    <label for="listTypeFee_id" class="form-label">Listing Fee Renewal <span class="text-danger">Required</span></label>
