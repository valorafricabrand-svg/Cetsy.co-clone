...
<div class="content">
  ...
  @if(session('success'))
    <div class="rounded-xl border px-4 py-3 text-sm border-emerald-200 bg-emerald-50 text-emerald-800 alert-dismissible fade show">
      {{ session('success') }}
  ...
  @if(session('error'))
    <div class="rounded-xl border px-4 py-3 text-sm border-rose-200 bg-rose-50 text-rose-700 alert-dismissible fade show">
      {{ session('error') }}
      <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
    </div>
  @endif
  ...
  <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
    <div class="p-4 p-0">
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-slate-200 text-sm table-hover mb-0">
          ...
          <tbody>
            @forelse($deals as $deal)
              <tr>
                ...
                <td>
                  <span class="inline-flex items-center rounded-full border px-2 py-0.5 text-[11px] font-semibold bg-emerald-100 text-emerald-800 border-emerald-200 fs-6">{{ $deal->discount_percent }}% OFF</span>
                </td>
                <td>
