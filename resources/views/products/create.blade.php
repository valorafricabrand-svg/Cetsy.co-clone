        ...
        <div class="col-12 col-xxl-9">
            <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" id="price" name="price" value="{{ old('price') }}" class="form-control" min="0" step="0.01" required>
                                    @error('price')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="number" id="discount_price" name="discount_price" value="{{ old('discount_price') }}" class="form-control" min="0" step="0.01">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" id="stock" name="stock" value="{{ old('stock',0) }}" class="form-control" min="0" step="1" required>
                                    @error('stock')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="number" id="low_stock" name="low_stock" value="{{ old('low_stock',0) }}" class="form-control" min="0" required>
                                    @error('low_stock')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                ...
                <div class="card p-4 mb-4">
                    <div class="border rounded-3 p-4">
                        ...
                        <div class="d-flex flex-column flex-xl-row mt-4 pt-4">
                            ...
                            <div class="flex-grow-1">
                                <input type="text" name="variation_one_name" class="form-control mb-3" placeholder="Variation Name example; Color" value="{{ old('variation_one_name') }}">
                                ...
                                <div id="variation-one-options-container"></div>
                            </div>
                        </div>
                        <div class="d-flex flex-column flex-xl-row mt-4 pt-4">
                            <div class="mb-3 mb-xl-0 me-xl-4" style="width: 256px;">
                            ...
                            <div class="flex-grow-1">
                                <input type="text" name="variation_two_name" class="form-control mb-3" placeholder="Variation Name" value="{{ old('variation_two_name') }}">
                                ...
                                <div id="variation-two-options-container"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="border rounded-3 p-4">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-flex flex-column flex-xl-row mt-4 pt-4">
                                ...
                                <div class="flex-grow-1">
                                    <select name="origin_id" class="form-select">
                                        ...
                                        <option value="{{ $country->id }}" {{ old('origin_id') == $country->id ? 'selected' : '' }}>{{ $country->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('origin_id')
                                    <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="d-flex flex-column flex-xl-row mt-4 pt-4">
                                ...
                                <div class="flex-grow-1">
                                    <input type="text" name="origin_postal_code" class="form-control" placeholder="Postal Code" value="{{ old('origin_postal_code') }}">
                            ...
                            <div class="d-flex flex-column flex-xl-row mt-4 pt-4">
                                ...
                                <div class="flex-grow-1">
                                    <select name="processing_time_id" class="form-select">
                                        ...
                                        <option value="{{ $processingtime->id }}" {{ old('processing_time_id') == $processingtime->id ? 'selected' : '' }}>
                            ...
                            <div class="d-flex flex-column flex-xl-row mt-4 pt-4">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <select name="local_shipping_service_id" id="local_shipping_service" class="form-select mb-3" onchange="toggleOtherShippingService(this.value, 'local')">
                                        ...
                                        <option value="{{ $val['id'] }}" {{ old('local_shipping_service_id') == $val['id'] ? 'selected' : '' }}>{{ $val['name'] }}</option>
                                        @endforeach
                                        <option value="0" {{ old('local_shipping_service_id') == '0' ? 'selected' : '' }}>Other</option>
                                    </select>
                                    @error('shipping_service_id')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    <div id="local_other_shipping_service" style="display: none;">
                                        <input type="text" name="local_shipping_service_other" class="form-control" placeholder="Please specify other shipping service" value="{{ old('local_shipping_service_other') }}">
                                    </div>
                                    ...
                                    <select name="localshippingPeriod_id" class="form-select">
                                        ...
                                        <option value="{{ $period->id }}" {{ old('localshippingPeriod_id') == $period->id ? 'selected' : '' }}>{{ $period->start_day }} to {{ $period->end_day }} days</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="d-flex flex-column flex-xl-row mt-4 pt-4">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <select name="shipping_type" class="form-select mb-3">
                                        ...
                                        <option value="{{ $type['id'] }}" {{ old('shipping_type') == $type['id'] ? 'selected' : '' }}>{{ $type['name'] }}</option>
                                        @endforeach
                                    </select>
                                    @error('shipping_type')
                                    <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="local_default_shipping_price" class="form-control" required value="{{ old('local_default_shipping_price') }}" step="0.001">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="local_shipping_price" class="form-control" value="{{ old('local_shipping_price') }}" step="0.001">
                            ...
                            <div class="d-flex flex-column flex-xl-row mt-4 pt-4">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <select name="international_shipping_service_id" id="international_shipping_service" class="form-select mb-3" onchange="toggleOtherShippingService(this.value, 'international')">
                                        <option value="">Select</option>
                                        @foreach ($shippinService as $val)
                                        <option value="{{ $val['id'] }}" {{ old('international_shipping_service_id') == $val['id'] ? 'selected' : '' }}>{{ $val['name'] }}</option>
                                        @endforeach
                                        <option value="0" {{ old('international_shipping_service_id') == '0' ? 'selected' : '' }}>Other</option>
                                    </select>
                                    @error('shipping_service_other_id')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    <div id="international_other_shipping_service" style="display: none;">
                                        <input type="text" name="international_shipping_service_other" class="form-control" placeholder="Please specify other shipping service" value="{{ old('international_shipping_service_other') }}">
                                    </div>
                                    <label class="fw-bold mt-3">Delivery Time</label>
                                    <select name="internationalshippingPeriod_id" class="form-select">
                                        <option value="">Select</option>
                                        @foreach ($shippingPeriods as $period)
                                        <option value="{{ $period->id }}" {{ old('internationalshippingPeriod_id') == $period->id ? 'selected' : '' }}>{{ $period->start_day }} to {{ $period->end_day }} days</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="d-flex flex-column flex-xl-row mt-4 pt-4">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <select name="shipping_type_other" class="form-select mb-3">
                                        @foreach ($shippingChargeType as $type)
                                        <option value="{{ $type['id'] }}" {{ old('shipping_type_other') == $type['id'] ? 'selected' : '' }}>{{ $type['name'] }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label class="fw-bold">One Item Fee</label>
                                            <input type="number" name="default_shipping_price" class="form-control" required value="{{ old('default_shipping_price') }}" step="0.001">
                                        ...
                                        <div class="col-md-6">
                                            <label class="fw-bold">Additional Item Fee</label>
                                            <input type="number" name="shipping_price" class="form-control" value="{{ old('shipping_price') }}" step="0.001">
                    ...
                    <div class="border rounded-3 p-4">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-flex flex-column flex-xl-row mt-4 pt-4">
                                ...
                                <div class="flex-grow-1">
                                    <div class="form-check form-switch">
                                        <input name="item_return" id="item_return" class="form-check-input" type="checkbox" value="1" {{ old('item_return') == 1 ? 'checked' : '' }}>
                            ...
                            <div class="d-flex flex-column flex-xl-row mt-4 pt-4">
                                ...
                                <div class="flex-grow-1">
                                    <div class="form-check form-switch">
                                        <input name="item_exchange" id="item_exchange" class="form-check-input" type="checkbox" value="1" {{ old('item_exchange') == 1 ? 'checked' : '' }}>
                            ...
                            <div class="d-flex flex-column flex-xl-row mt-4 pt-4">
                                ...
                                <div class="flex-grow-1">
                                    <select name="total_return_days" class="form-select">
                                        ...
                                        <option value="{{ $returnDelivery['id'] }}" {{ old('total_return_days') == $returnDelivery['id'] ? 'selected' : '' }}>{{ $returnDelivery['name'] }}</option>
                                        @endforeach
                                    </select>
                ...
                <div class="d-flex flex-column flex-md-row justify-content-end gap-3 mt-4">
                    <button type="submit" class="btn btn-primary w-100 w-md-auto">Save Product</button>
                </div>
            </form>
        </div>
    </div>
