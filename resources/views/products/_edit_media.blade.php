{{-- ─── Upload & Crop New Images (Modern, polished, modal-filling cropper) ─── --}}
@push('styles')
...
<div x-data="modernUploader()" class="card shadow-sm mb-5">
  ...
  <form x-ref="form"
    ...
    <div class="dropzone rounded-3 py-5 text-center mb-4"
      ...
      <input type="file" class="d-none" multiple accept="image/*" x-ref="file" @change="addFiles($event.target.files)">
    </div>
          ...
          <div class="col-6 col-sm-4 col-md-3">
            <div class="position-relative border rounded thumb overflow-hidden shadow-sm">
              ...
              <div class="position-absolute top-0 end-0 m-1 d-flex flex-column gap-1">
                <button type="button" class="btn btn-sm btn-warning toolbar-btn" @click.prevent="openCrop(i)" title="Crop">
                  <i class="fas fa-crop"></i>
                </button>
                <button type="button" class="btn btn-sm btn-danger toolbar-btn" @click.prevent="remove(i)" title="Remove">
              ...
              {{-- Mini progress (optional if you add per-file upload) --}}
